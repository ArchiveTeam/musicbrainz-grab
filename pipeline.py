...
project = Project(
    ...
    project_html="""
        ...
        <h2>musicbrainz.org <span class="links"><a href="http://musicbrainz.org/">Website</a> &middot; <a href="http://tracker.archiveteam.org/musicbrainz/">Leaderboard</a></span></h2>
